...
namespace FighterXD.Main
{
    public class GameObject : Object, IDrawable
    {
        ...
        protected override void AddInfoToCopy(Object copy)
        {
            ...
            ((GameObject)copy).sprite = sprite;
            ((GameObject)copy).color = color;
            ((GameObject)copy).spriteSize = spriteSize;
            ((GameObject)copy).depth = depth;
            ((GameObject)copy).localOrgin = localOrgin;
            ((GameObject)copy).effects = effects;
        }
    ...
    public class PhysicalObject : GameObject
    {
        ...
        {
            base.AddInfoToCopy(copy);
            ((PhysicalObject)copy).Collider = (Collider)Collider.CreateCopy();
        }
    ...
    public class RigidObject : PhysicalObject
    {
        ...
        {
            base.AddInfoToCopy(copy);
            ((RigidObject)copy).collisionsOn = collisionsOn;
        }
